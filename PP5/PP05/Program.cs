...
class Programm {
    static void Main(string[] args)
    {
...

        {
            ...
            bool testresult = testSHA512_SA(result, Lab05Lib.Constant.Delimiter);
        ...
        }
        {
            ...
            reader.Close();
            bool testresult = testSHA512_SA(message, Lab05Lib.Constant.Delimiter);
        ...
        }
        {
            ...
            bool testresult = testMD5_SA(result, Lab05Lib.Constant.Delimiter);
        ...
        }
        {
            ...
            StreamReader reader = new StreamReader(result);
            string? message = reader.ReadLine();
            bool testresult = testMD5_SA(message, Lab05Lib.Constant.Delimiter);
        ...
        }
        {
            ...
            bool testresult = testSHA512(result, Lab05Lib.Constant.Delimiter);
        ...
        }
        {
            ...
            bool testresult = testMD5(result, Lab05Lib.Constant.Delimiter);
        ...
        }
        {
            IWriter writer = new StrWriter();
            IWriter hash = new DecSHA512(writer);
            string? result = hash.Save(string.Format("{0}{1}{2}", "AAAAA", Lab05Lib.Constant.Delimiter, "BBBBCCCCC"));  // разделитель в тексте
        ...
        }
        {
            IWriter writer = new StrWriter();
            IWriter hash = new DecMD5(writer);
            string? result = hash.Save(string.Format("{0}{1}{2}", "AAAAA", Lab05Lib.Constant.Delimiter, "BBBBCCCCC"));
            bool testresult = testSHA512(result, Lab05Lib.Constant.Delimiter);
        ...
        }
        {
            ...
            StreamReader reader = new StreamReader(result);
            string? message = reader.ReadLine();
            bool testresult = testSHA512_SA("BBBBXCCCC", Lab05Lib.Constant.Delimiter);
